...
# Importa as novas classes de otimizador v2
from optimizers_v2_1 import SIGMA_D_v2, SIGMA_C_v2
...
def train_epoch(model, optimizer, train_loader, device, loss_fn):
    ...
    for data, target in train_loader:
        ...
        # *** MODIFICADO AQUI para v2 ***
        # Passa loss_item se for SIGMA-D_v2 ou SIGMA-C_v2
        if isinstance(optimizer, (SIGMA_D_v2, SIGMA_C_v2)):
